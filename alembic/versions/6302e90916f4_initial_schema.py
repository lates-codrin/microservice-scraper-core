...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_scraped_documents_job_id'), 'scraped_documents', ['job_id'], unique=False)
    op.create_index(op.f('ix_scraped_documents_tenant_id'), 'scraped_documents', ['tenant_id'], unique=False)
    op.create_index('idx_tenant_job_doc_conf', 'scraped_documents', ['tenant_id', 'job_id', 'doc_type', 'doc_type_confidence'], unique=False)

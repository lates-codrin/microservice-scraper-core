...
def test_domain_diacritics(auth_headers, mock_store):
    ...
    from app.models.document import ScrapedDocument, ContentType, DocType
...
def test_domain_cross_tenant_isolation(auth_headers, mock_store):
    ...
    mock_job = CrawlJob(
        ...
        progress=CrawlProgress(stage="done", urls_discovered=1, urls_fetched=1, documents_extracted=1, documents_classified=1, urls_pending=0, bytes_downloaded=100),

...
from sqlalchemy import JSON, String, ForeignKey, Float, Index, Integer, DateTime
from sqlalchemy.dialects.postgresql import JSONB
from sqlalchemy.orm import DeclarativeBase, Mapped, mapped_column, relationship
from sqlalchemy.sql import func
from datetime import datetime

from app.models.enums import CrawlStatus, ContentType, DocType
...
class DbScrapedDocument(Base):
    ...
    job_id: Mapped[str] = mapped_column(ForeignKey("crawl_jobs.job_id", ondelete="CASCADE"), index=True)
    tenant_id: Mapped[str] = mapped_column(String, index=True)
